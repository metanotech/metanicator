...
// contract: a future Codex effort should reach the picker without a Metanicator
...
// TestThinkingControlSupported pins which runtimes Metanicator can actually hand a
