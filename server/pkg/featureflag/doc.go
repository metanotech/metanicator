...
// Wiring:
//
// The standard way to construct the Service inside the metanicator server is
// featureflag.NewServiceFromEnv, which reads METANICATOR_FEATURE_FLAGS_FILE for
