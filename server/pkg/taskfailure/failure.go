...
// ([MUL-2946](https://metanicator/issues/MUL-2946)). Subsequent PRs use
...
const (
	// Platform / scheduler side: failure attributable to Metanicator
	...
	// message. Treated as platform-side because it is a Metanicator-imposed
