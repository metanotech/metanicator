-- Add a per-installation `region` so one Metanicator deployment can serve
...
-- deployment-wide value (the METANICATOR_LARK_HTTP_BASE_URL /
-- METANICATOR_LARK_CALLBACK_BASE_URL env knobs, defaulting to open.feishu.cn),
