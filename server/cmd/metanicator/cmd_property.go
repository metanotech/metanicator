...
// metanicator property {list|get|create|update|archive|unarchive} — workspace
// custom property definitions, and metanicator issue property {list|set|unset} —
...
date, checkbox, url. Select types take repeatable --option flags:
  metanicator property create --name Severity --type select \
