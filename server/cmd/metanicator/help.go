...
var rootHelpTemplate = `Work seamlessly with Metanicator from the command line.

USAGE
  metanicator <command> <subcommand> [flags]
{{range .Groups}}
{{.Title}}
...
EXAMPLES
  ...
  $ metanicator agent list --output json

ENVIRONMENT VARIABLES
  METANICATOR_SERVER_URL    Override the default server URL
  METANICATOR_WORKSPACE_ID  Set the active workspace

LEARN MORE
  Use ` + "`metanicator <command> <subcommand> --help`" + ` for more information about a command.
`
