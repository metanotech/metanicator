...
// Tests for `metanicator issue metadata list` 404-degradation behavior, plus
...
// endpoint working.
//
// Background: GitHub issue metanicator-ai/metanicator#3711 — on self-hosted
// backends that pre-date the per-issue metadata route, agent runtime
// bootstrap calls `metanicator issue metadata list <issue> --output json`
