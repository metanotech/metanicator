...
func TestEnvPositiveIntOrDefault(t *testing.T) {
	const key = "METANICATOR_TEST_ENV_INT"
	cases := []struct {
		name string
		set  bool
		val  string
...
func TestNewDaemonLogRotatorDefaults(t *testing.T) {
	os.Unsetenv("METANICATOR_DAEMON_LOG_MAX_SIZE_MB")
	os.Unsetenv("METANICATOR_DAEMON_LOG_MAX_BACKUPS")
	os.Unsetenv("METANICATOR_DAEMON_LOG_MAX_AGE_DAYS")
...
func TestNewDaemonLogRotatorEnvOverride(t *testing.T) {
	t.Setenv("METANICATOR_DAEMON_LOG_MAX_SIZE_MB", "5")
	t.Setenv("METANICATOR_DAEMON_LOG_MAX_BACKUPS", "2")
	t.Setenv("METANICATOR_DAEMON_LOG_MAX_AGE_DAYS", "7")
...
func TestDaemonLogRotatorRotates(t *testing.T) {
	t.Setenv("METANICATOR_DAEMON_LOG_MAX_SIZE_MB", "1")
	t.Setenv("METANICATOR_DAEMON_LOG_MAX_BACKUPS", "3")
