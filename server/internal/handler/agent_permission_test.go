...
func TestCanInvokeAgent_PublicToMemberWhitelist(t *testing.T) {
	...
	allowedMember := createPermissionTestMember(t, "perm-allowed-member@metanicator.test")
	otherMember := createPermissionTestMember(t, "perm-other-member@metanicator.test")
...
func TestCanInvokeAgent_MixedMemberAndTeamTargets(t *testing.T) {
	...
	memberA := createPermissionTestMember(t, "perm-mix-a@metanicator.test")
	memberB := createPermissionTestMember(t, "perm-mix-b@metanicator.test")
...
func TestUpdateAgent_BatchReplaceOverlappingMembers(t *testing.T) {
	...
	memberA := createPermissionTestMember(t, "perm-batch-a@metanicator.test")
	memberB := createPermissionTestMember(t, "perm-batch-b@metanicator.test")
	memberC := createPermissionTestMember(t, "perm-batch-c@metanicator.test")
...
func TestUpdateAgent_WorkspaceStacksWithMembersThenNarrowed(t *testing.T) {
	...
	memberA := createPermissionTestMember(t, "perm-stack-a@metanicator.test")
	memberB := createPermissionTestMember(t, "perm-stack-b@metanicator.test")
	...
	memberC := createPermissionTestMember(t, "perm-stack-c@metanicator.test")
	w := httptest.NewRecorder()
	r := newRequest("PUT", "/api/agents/"+agentID, map[string]any{
		"permission_mode": "public_to",
		"invocation_targets": []map[string]any{
...
func TestCreateAgent_EmptyPublicToNormalizesToWorkspace(t *testing.T) {
	...
	someMember := createPermissionTestMember(t, "perm-emptypublic-m@metanicator.test")
...
func TestCanInvokeAgent_SystemWorkspaceExceptionAndMemberFailClosed(t *testing.T) {
	...
	memberX := createPermissionTestMember(t, "perm-sys-failclosed@metanicator.test")
...
func TestRevokeMember_ClearsInvocationTargets(t *testing.T) {
	...
	memberX := createPermissionTestMember(t, "perm-revoke-x@metanicator.test")
...
func TestRevokeMember_InvocationTargetCleanupIsWorkspaceScoped(t *testing.T) {
	...
	userX := createPermissionTestMember(t, "perm-xws@metanicator.test")
...
func TestUpdateAgent_AccessChangeIsOwnerOnly(t *testing.T) {
	...
	adminID := createPermissionTestAdmin(t, "perm-access-admin@metanicator.test")
...
func TestUpdateAgent_LegacyVisibilityNoOpForMemberOnlyPublicTo(t *testing.T) {
	...
	memberX := createPermissionTestMember(t, "perm-legacyvis-x@metanicator.test")
	agentID := createPublicToAgentWithTargets(t, "legacy-vis-member-only-agent", []map[string]any{
		{"target_type": "member", "target_id": memberX},
	})
	adminID := createPermissionTestAdmin(t, "perm-legacyvis-admin@metanicator.test")
