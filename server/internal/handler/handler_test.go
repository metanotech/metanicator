...
const (
	handlerTestEmail         = "handler-test@metanicator.ai"
...
func TestSendCode(t *testing.T) {
	w := httptest.NewRecorder()
	body := map[string]string{"email": "sendcode-test@metanicator.ai"}
	var buf bytes.Buffer
	json.NewEncoder(&buf).Encode(body)
	...
	t.Cleanup(func() {
		testPool.Exec(context.Background(), `DELETE FROM verification_code WHERE email = $1`, "sendcode-test@metanicator.ai")
	})
}
...
func TestSendCodeDbError(t *testing.T) {
	...
	w := httptest.NewRecorder()
	body := map[string]string{"email": "dberror-test@metanicator.ai"}
	var buf bytes.Buffer
	json.NewEncoder(&buf).Encode(body)
	req := httptest.NewRequest("POST", "/auth/send-code", &buf)
	req.Header.Set("Content-Type", "application/json")
...
func TestSendCodeRateLimit(t *testing.T) {
	const email = "ratelimit-test@metanicator.ai"
	t.Cleanup(func() {
...
func TestVerifyCode(t *testing.T) {
	const email = "verify-test@metanicator.ai"
	ctx := context.Background()
...
func TestVerifyCodeRejectsDevCodeUnlessExplicitlyConfigured(t *testing.T) {
	...
	const email = "dev-code-disabled-test@metanicator.ai"
	ctx := context.Background()
...
func TestVerifyCodeAcceptsConfiguredDevCodeOutsideProduction(t *testing.T) {
	...
	const email = "dev-code-enabled-test@metanicator.ai"
	ctx := context.Background()
...
func TestVerifyCodeRejectsConfiguredDevCodeInProduction(t *testing.T) {
	...
	const email = "dev-code-production-test@metanicator.ai"
	ctx := context.Background()
...
func TestVerifyCodeWrongCode(t *testing.T) {
	...
	const email = "wrong-code-test@metanicator.ai"
	ctx := context.Background()
...
func TestVerifyCodeBruteForceProtection(t *testing.T) {
	...
	const email = "bruteforce-test@metanicator.ai"
	ctx := context.Background()
...
func TestVerifyCodeNewUserHasNoWorkspace(t *testing.T) {
	const email = "workspace-verify-test@metanicator.ai"
	ctx := context.Background()
