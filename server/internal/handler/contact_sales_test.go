...
func TestCanonicalBusinessEmail(t *testing.T) {
	cases := []struct {
		...
		{"plain", "ada@metanicator.ai", "ada@metanicator.ai", true},
		{"uppercase normalized", "Ada@Metanicator.AI", "ada@metanicator.ai", true},
		{"trim whitespace", "  ada@metanicator.ai  ", "ada@metanicator.ai", true},
		{"display name stripped", "Ada Lovelace <ada@metanicator.ai>", "ada@metanicator.ai", true},
		{"angle-bracketed", "<ada@metanicator.ai>", "ada@metanicator.ai", true},
		{"empty", "", "", false},
		{"only whitespace", "   ", "", false},
		{"missing at", "no-at-sign", "", false},
		{"missing local", "@metanicator.ai", "", false},
