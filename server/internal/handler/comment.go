...
// emitted via the X-Metanicator-Next-Before / X-Metanicator-Next-Before-Id
// response headers.
//
...
func (h *Handler) ListComments(w http.ResponseWriter, r *http.Request) {
	...
	if result.NextBefore != "" && result.NextBeforeID != "" {
		w.Header().Set("X-Metanicator-Next-Before", result.NextBefore)
		w.Header().Set("X-Metanicator-Next-Before-Id", result.NextBeforeID)
	}
