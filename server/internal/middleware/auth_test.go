...
func TestAuth_ValidToken(t *testing.T) {
	...
	if gotEmail != "test@metanicator.ai" {
		t.Fatalf("expected X-User-Email 'test@metanicator.ai', got '%s'", gotEmail)
	}
}
...
// as the daemon side: with no METANICATOR_CLOUD_FLEET_URL configured, an
