...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.metanicator.ai"
	cookieDomain string // cookie scope, e.g. ".metanicator.ai"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.metanicator.ai")
//   - COOKIE_DOMAIN           (e.g. ".metanicator.ai")
