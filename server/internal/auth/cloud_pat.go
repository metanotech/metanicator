...
// (Metanicator Cloud Node) PAT. Tokens with this prefix are validated by
// calling the Metanicator Cloud Fleet service rather than by hitting our
...
// METANICATOR_CLOUD_FLEET_URL configured simply rejects mcn_ tokens at
...
type CloudPATVerifierConfig struct {
	...
	// https://fleet.metanicator.cloud). Trailing slashes are trimmed.
