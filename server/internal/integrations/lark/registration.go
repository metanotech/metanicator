...
//     and an expiry. Metanicator renders the QR, the user scans it in the
...
type RegistrationConfig struct {
	...
	// telemetry can attribute installs back to Metanicator. Empty defaults
	// to "metanicator".
	Source string
...
type BeginResult struct {
	DeviceCode string
	// QRCodeURL is the verification_uri_complete with Metanicator's `source`
...
// cannot attribute installs back to Metanicator in their analytics.
//
