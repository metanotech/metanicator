...
func NewBusinessMetrics() *BusinessMetrics {
	...
	m := &BusinessMetrics{
		...
		}, metricLabels("metanicator_agent_task_queue_wait_seconds")),
		taskRunSeconds: prometheus.NewHistogramVec(prometheus.HistogramOpts{
			...
			Buckets:   taskDurationBuckets,
		}, metricLabels("metanicator_agent_task_run_seconds")),
		taskTotalSeconds: prometheus.NewHistogramVec(prometheus.HistogramOpts{
			...
			Buckets:   taskDurationBuckets,
		}, metricLabels("metanicator_agent_task_total_seconds")),
		...
		}, metricLabels("metanicator_agent_task_in_progress")),
		...
		}, metricLabels("metanicator_llm_unpriced_tokens_total")),
		...
		}, metricLabels("metanicator_llm_request_total")),
		...
		}, metricLabels("metanicator_task_queued_expired_total")),
		...
		}, metricLabels("metanicator_task_lease_expired_total")),
		activeTasks: map[string]activeTaskLabels{},
