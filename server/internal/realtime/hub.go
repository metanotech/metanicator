...
// loadTrustedProxies reads the same METANICATOR_TRUSTED_PROXIES env var the rest of
...
func loadTrustedProxies() []netip.Prefix {
	raw := strings.TrimSpace(os.Getenv("METANICATOR_TRUSTED_PROXIES"))
	if raw == "" {
		return nil
	}
...
// shared METANICATOR_TRUSTED_PROXIES value in here at startup.
