...
| --- | --- | --- |
| `workspace member list` | `user_id` (NOT the membership-row id) | `server/cmd/metanicator/cmd_workspace.go:465` |
| `agent list` | `id` | `server/cmd/metanicator/cmd_agent.go:365` |
| `squad list` | `id` | `server/cmd/metanicator/cmd_squad.go:57` |
