...
This file records source evidence for `metanicator-squads/SKILL.md`.
...
```text
server/cmd/metanicator/cmd_squad.go
```
...
metanicator squad get <squad-id>
metanicator squad create
metanicator squad update <squad-id>
metanicator squad delete <squad-id>
metanicator squad activity <issue-id> <outcome>

metanicator squad member list <squad-id>
metanicator squad member add <squad-id>
metanicator squad member remove <squad-id>
...
- agent member roster rows list assigned workspace skills via
  ...
  "no skills assigned"; builtin metanicator-* skills are excluded and human
...
- parent status is not auto-advanced by the barrier: the system comment asks the
  ...
  `metanicator issue status <parent-id> in_review`. That explicit ask is what lets a
