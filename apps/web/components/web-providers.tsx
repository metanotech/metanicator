...
import { createBrowserCookieLocaleAdapter } from "@metanicator/core/i18n/browser";
import type { LocaleResources, SupportedLocale } from "@metanicator/core/i18n";
...
// cookie mode on their next logout/login cycle (logout clears metanicator_token).
// Sunset: once telemetry shows <1% of sessions still carry metanicator_token,
...
function hasLegacyToken(): boolean {
  ...
  try {
    return Boolean(window.localStorage.getItem("metanicator_token"));
  } catch {
    return false;
  }
}
