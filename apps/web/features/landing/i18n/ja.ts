...
export function createJaDict(allowSignup: boolean): LandingDict {
  ...
  return {
    ...
    hero: {
      ...
      subheading:
        "Metanicator は、コーディングエージェントを本物のチームメンバーに変えるオープンソースプラットフォームです。タスクを割り当て、進捗を追い、ノウハウをスキルとして積み上げる。人間と AI エージェントから成るチームを、ひとつの場所で管理できます。",
      cta: "無料トライアルを始める",
      downloadDesktop: "デスクトップ版をダウンロード",
      talkToSales: "営業に相談する",
      worksWith: "対応ツール",
      imageAlt: "人間と AI エージェントがタスクを管理する Metanicator のボード画面",
    },
    features: {
      teammates: {
        label: "チームメイト",
      ...
      runtimes: {
        ...
        cards: [
          ...
          },
          {
            title: "初回起動時に自動検出",
            description:
              "Metanicator は Antigravity、Claude Code、CodeBuddy、Codex、Cursor、Copilot、Hermes、Kimi、Reasonix、Kiro CLI、OpenCode、OpenClaw、Pi、Qoder、Trae CLI という15種類の対応ツールをスキャンし、見つかったものをそれぞれランタイムとして登録します。",
          },
        ],
      },
    },
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          ...
          description:
            "metanicator setup を実行すると、OAuth の手順を案内し、デーモンを起動し、15種類の対応コーディングツール(Antigravity、Claude Code、CodeBuddy、Codex、Cursor、Copilot、Hermes、Kimi、Reasonix、Kiro CLI、OpenCode、OpenClaw、Pi、Qoder、Trae CLI)をスキャンします。すでにインストール済みのものは、自動的にランタイムとして登録されます。",
        },
        {
          title: "最初のエージェントを作成",
          description:
    ...
    openSource: {
      ...
      description:
        "Metanicator は完全なオープンソースです。すべてのコードを確認し、自分の条件でセルフホストし、人間と AI エージェントが協働する未来を、ともに形づくっていけます。",
      cta: "GitHub でスターを付ける",
      highlights: [
        {
          title: "どこでもセルフホスト",
          description:
            "自社のインフラで Metanicator を運用できます。Docker Compose、単一バイナリ、Kubernetes に対応。データがネットワークの外に出ることはありません。",
        },
        {
          title: "ベンダーロックインなし",
          description:
    ...
    faq: {
      ...
      items: [
        {
          question: "Metanicator はどのコーディングエージェントに対応していますか?",
          answer:
            "Metanicator は、Antigravity、Claude Code、CodeBuddy、Codex、Cursor、Copilot、Hermes、Kimi、Reasonix、Kiro CLI、OpenCode、OpenClaw、Pi、Qoder、Trae CLI の15種類のコーディングツールに標準対応しています。デーモンが、すでにインストール済みの CLI を自動検出し、それぞれをランタイムとして登録します。オープンソースなので、独自のバックエンドを追加することもできます。",
        },
        {
        ...
        },
        {
          ...
          answer:
            "コーディングエージェントは実行が得意です。Metanicator はその上に、タスクキュー、チームの連携、スキルの再利用、ランタイムの監視、そして各エージェントの動きを一望できる統合ビューという管理レイヤーを加えます。エージェントのためのプロジェクトマネージャーだと考えてください。",
        },
        {
          question: "エージェントは長時間のタスクを自律的にこなせますか?",
          answer:
            "はい。Metanicator は、キュー追加・受け取り・実行・完了または失敗まで、タスクのライフサイクル全体を管理します。エージェントは詰まったところを先に知らせ、進捗をリアルタイムにストリーミングします。好きなときに覗いてもよいですし、一晩じゅう走らせておくこともできます。",
        },
        {
          question: "コードは安全ですか? エージェントの実行はどこで行われますか?",
          answer:
            "エージェントの実行は、あなたのマシン(ローカルデーモン)、または自社のクラウドインフラ上で行われます。コードが Metanicator のサーバーを経由することはありません。プラットフォームはタスクの状態を調整し、イベントを配信する役割だけを担います。",
        },
        {
    ...
    changelog: {
      title: "変更履歴",
      subtitle: "Metanicator の新しいアップデートと改善点をお届けします。",
      toc: "すべてのリリース",
      categories: {
        features: "新機能",
        improvements: "改善",
      ...
      entries: [
        {
          ...
          features: [
            ...
            "metanicator や Agent CLI を差し替えると、再起動なしでそのまま反映されます。",
          ],
          improvements: [
        ...
        },
        {
          ...
          improvements: [
            ...
            "多くのワークスペースがあっても、Metanicator の起動時にエージェントツールを何度も確認しなくなりました。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "ダイレクト チャットの返信が Metanicator 内に残るようになりました。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "Linux 版デスクトップ アプリが metanicator-desktop という名前でインストールされます。",
          ],
        },
        {
          version: "0.4.2",
        ...
        },
        {
          ...
          features: [
            ...
            "セルフホスト（Helm）：新しい `postgres.external.enabled` トグルで Metanicator を外部管理の PostgreSQL（RDS、CNPG、Cloud SQL、Neon など）に向けられ、内蔵データベースをスキップできます。",
          ],
          fixes: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Slack のネイティブ /issue スラッシュ コマンドで Metanicator タスクを作成し、実行者だけにタスクリンクを私信で返します。",
            "同じ Slack ワークスペースで既に一方の Metanicator ボットに連携済みのユーザーは、別のボットが加わっても再連携を求められなくなりました。",
          ...
          fixes: [
            ...
            "セルフホスト：docker-compose.selfhost.yml で METANICATOR_SLACK_SECRET_KEY をバックエンド コンテナへ引き渡すようになりました。（コミュニティ報告）",
            "タスク一覧上部の「N 件処理中」チップが、エージェントではなくタスクの数を数えるようになりました。",
            "セルフホストの匿名ソース チャネル送信先を正式な Metanicator API エンドポイントに戻しました。",
        ...
        },
        {
          ...
          features: [
            ...
            "Slack チャンネルの過去のやり取りを Metanicator にバックフィルでき、エージェントが加わった時点で会話の流れをそのまま把握できます。",
            "Slack でエージェントが返信を準備している間、ユーザーのメッセージに 👀 のリアクションが付き、終了時に確実に外れます。",
            "スキル パッケージをローカルの .skill / .zip アーカイブから取り込めるようになりました。",
            "metanicator issue 系のコマンドは短い UUID プレフィックスを受け付けなくなりました。タスク Key（MUL-123）または完全な UUID を指定してください。",
        ...
        },
        {
          ...
          features: [
            ...
            "Cursor と OpenClaw の設定が簡単になりました。Cursor の接続設定は Metanicator に任せられ、OpenClaw は既存のゲートウェイにも接続できます。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "CodeBuddy でローカルの Metanicator エージェントを動かせるようになり、利用できるモデルと実行の強さが自動で表示されます。",
        ...
        },
        {
          ...
          features: [
            ...
            "Claude Fable 5 が Metanicator の対応モデルと料金一覧に加わりました。",
            "タスクの会話で特定の返信を解決として残せるようになり、長いスレッドを閉じても結論を確認しやすくなりました。",
            "Lark と Feishu の会話では、Metanicator が返信を準備している間に入力中のリアクションを表示し、返信前に自動で消します。",
          ...
          improvements: [
            ...
            "WSL2 など Metanicator の外でデーモンが管理されている場合、デスクトップは開始と停止の操作を無効にします。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Web アプリでブラウザー標準の通知バナーを表示できるようになり、Metanicator がバックグラウンドでもワークスペースの動きに気づきやすくなりました。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Metanicator は Lark のサードパーティ連携に対応し、QR コードを読み取るだけで Metanicator エージェントを Lark Bot として作成できます。",
            "チャットに検索できるエージェント選択と明示的なコンテキスト選択が加わり、誰に任せるか、何を見せるかを選びやすくなりました。",
            "説明とコメントでチェックリストを使えるようになり、タスク内の軽い計画を整理しやすくなりました。",
            "エージェントに Metanicator の組み込みスキルが加わり、ワークスペースの進め方により沿いやすくなりました。",
          ],
          improvements: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Metanicator がアプリ、サイト、ドキュメントで日本語に対応しました。",
        ...
        },
        {
          ...
          features: [
            ...
            "Metanicator がアプリ、ウェブサイト、ドキュメントで韓国語に対応し、韓国語のドキュメントページや日付表示のローカライズも提供します。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "初めて実用的なモバイルクライアントとなる Metanicator for iOS をリリースし、ログイン・ワークスペース・インボックス・タスク・プロジェクト・チャット・コメント・リアルタイム更新をすべて利用できます。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "GitHub を接続して、連携した Pull request を Metanicator のタスクに表示し、状態を同期し、PR がクローズされたときにタスクを自動的に閉じられます。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`metanicator daemon disk-usage` が、作業ごと・ワークスペースごとのディスク使用量を表示します。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`metanicator repo checkout --ref` が、ブランチ、タグ、特定のコミットを対象にリポジトリを取得できます。",
            "`metanicator agent avatar` が、CLI からエージェントのアバターを直接アップロードします。",
          ...
          fixes: [
            "新しいエージェントの即時表示、Hermes の以前の回答の再生、Codex の GPT-5.5 モデル表示、`metanicator login --token`、CLI 更新の状態、session resume、Kanban 設定、オートパイロットのレスポンシブ対応などを修正しました。",
          ],
        },
        {
          version: "0.2.21",
          ...
          improvements: [
            "デーモンの claim polling の Redis fast-path、Metanicator Agent のコミットの Co-authored-by trailer、デスクトップの reload 抑止が改善されました。",
          ],
          fixes: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`metanicator agent create/update --custom-env KEY=VALUE` が、エージェントの実行にカスタム環境変数を注入します。",
        ...
        },
        {
          ...
          title: "コアプラットフォーム",
          changes: [
            "Metanicator のコアプラットフォーム機能を追加しました。",
          ],
        },
        {
          version: "0.1.0",
    ...
    about: {
      ...
      paragraphs: [
        ...
        "いま、同じような転換点がふたたび訪れていると私たちは考えています。この数十年、ソフトウェアチームは事実上シングルスレッドで働いてきました。一人のエンジニアが、ひとつのタスクを担い、一度にひとつの文脈だけを切り替えながら進める。AI エージェントは、その方程式を変えます。Metanicator はタイムシェアリングをふたたび呼び戻します。ただし今回は、システムを多重利用する「ユーザー」が、人間と自律的なエージェントの両方である時代に合わせて。",
        "Metanicator では、エージェントは一級のチームメンバーです。人間の同僚とまったく同じように、タスクを割り当てられ、進捗を報告し、行き詰まりを知らせ、コードをリリースします。担当者の選択、アクティビティタイムライン、作業のライフサイクル、そしてランタイムのインフラは、すべてこの前提を中心に、最初から設計されています。",
    ...
    contactSales: {
      pageTitle: "営業に相談",
      pageDescription:
        "人間と AI エージェントが協働するワークフローを社内に導入する方法について、Metanicator チームにご相談ください。",
      eyebrow: "営業に相談",
      ...
      fields: {
        ...
        companySize: "会社規模",
        countryRegion: "国 / 地域",
        useCase: "Metanicator をどのように利用、または活用するご予定ですか?",
        goals: "目標または現在抱えている課題",
        goalsHint:
          "Metanicator で実現したいことや、いま直面している課題をお聞かせください。詳しくご記入いただくほど、より的確にお手伝いできます。",
      ...
      useCases: [
        ...
        { value: "adopt_team", label: "チームまたは会社に Metanicator を導入" },
        { value: "self_host", label: "自社インフラにセルフホスト" },
        { value: "integrate", label: "既存ツールと Metanicator を連携" },
      ...
      consent: {
        intro:
          "Metanicator, Inc. はあなたのプライバシーを尊重します。お預かりした個人情報は、アカウントの管理と、ご依頼いただいた製品・サービスの提供のためにのみ使用します。ときどき、製品アップデートやベストプラクティス、ご参考になりそうなインサイトもお届けできればと思います。ご希望の場合は、下でお知らせください。",
        outreach:
          "サービスのアップデート、サポートへのお問い合わせ、ビジネス関連のフォローアップなど、Metanicator, Inc. からの個別のご連絡を受け取ります。",
        updates:
          "Metanicator からの製品アップデート、インサイト、イベントへのご招待を受け取ります。",
        unsubscribe:
          "配信はいつでも停止できます。データの取り扱いとプライバシーの権利について詳しくは、こちらをご確認ください:",
        submitConsent:
          "「送信」をクリックすると、ご依頼いただいたコンテンツをお届けするために、Metanicator, Inc. が情報を保存・処理することに同意したことになります。",
      ...
      success: {
        ...
        message:
          "Metanicator チームのメンバーが、3営業日以内にご返信いたします。それまでの間、ドキュメントを覗いてみたり、GitHub でスターを付けたりしてお待ちください。",
        cta: "ホームに戻る",
      },
      errors: {
