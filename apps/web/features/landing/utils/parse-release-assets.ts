 ...
 *   metanicator-desktop-{version}-mac-{arch}.{dmg|zip}
 *   metanicator-desktop-{version}-windows-{arch}.exe
 *   metanicator-desktop-{version}-linux-{arch}.{AppImage|deb|rpm}
 *
...
const DESKTOP_ARTIFACT_RE =
  /^metanicator-desktop-[^-]+-(mac|windows|linux)-([a-z0-9_]+)\.(dmg|zip|exe|AppImage|deb|rpm)$/i;
