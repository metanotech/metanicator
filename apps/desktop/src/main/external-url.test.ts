...
describe("isSafeExternalHttpUrl", () => {
  it("allows http and https URLs", () => {
    expect(isSafeExternalHttpUrl("https://metanicator.ai")).toBe(true);
...
describe("openExternalSafely", () => {
  ...
  it("forwards http/https URLs to shell.openExternal", () => {
    openExternalSafely("https://metanicator.ai");
    expect(shell.openExternal).toHaveBeenCalledWith("https://metanicator.ai");
  });
