...
describe("prefixLocale", () => {
  ...
  it("leaves external URLs alone", () => {
    expect(prefixLocale("https://metanicator.ai/download", "zh")).toBe(
      "https://metanicator.ai/download",
    );
    expect(prefixLocale("mailto:hello@metanicator.ai", "zh")).toBe(
      "mailto:hello@metanicator.ai",
    );
