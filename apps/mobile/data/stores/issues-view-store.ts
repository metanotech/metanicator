 ...
 * `@metanicator/core/issues/stores/issues-scope-store` — mobile only
 * `import type` from `@metanicator/core/types/*` per Sharing Principles, and
...
import type { IssuePriority, IssueStatus } from "@metanicator/core/types";
