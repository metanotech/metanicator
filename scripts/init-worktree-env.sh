...
postgres_db="metanicator_${slug}_${offset}"
postgres_port=5432
...
DATABASE_URL=postgres://metanicator:metanicator@localhost:${postgres_port}/${postgres_db}?sslmode=disable

PORT=${backend_port}
JWT_SECRET=change-me-in-production
METANICATOR_DEV_VERIFICATION_CODE=888888
METANICATOR_SERVER_URL=ws://localhost:${backend_port}/ws
METANICATOR_PUBLIC_URL=http://localhost:${backend_port}
