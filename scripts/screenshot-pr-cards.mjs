...
const DB = process.env.DATABASE_URL || "postgres://metanicator:metanicator@localhost:5432/metanicator_metanicator_101?sslmode=disable";
...
async function main() {
  ...
  await page.evaluate((t) => localStorage.setItem("metanicator_token", t), token);
