...
#   $env:MULTICA_MODE="local"; irm https://raw.githubusercontent.com/metanotech/metanicator/main/scripts/install.ps1 | iex
#
...
function Install-CliBinary {
    ...
    $url = "https://github.com/metanotech/metanicator/releases/download/$latest/multica-cli-$version-windows-$arch.zip"
...
function Start-DefaultInstall {
    ...
    Write-Host '     $env:MULTICA_MODE="with-server"; irm https://raw.githubusercontent.com/metanotech/metanicator/main/scripts/install.ps1 | iex'
    Write-Host ""
}
...
function Start-LocalInstall {
    ...
    Write-Host '     $env:MULTICA_MODE="stop"; irm https://raw.githubusercontent.com/metanotech/metanicator/main/scripts/install.ps1 | iex'
    Write-Host ""
}
