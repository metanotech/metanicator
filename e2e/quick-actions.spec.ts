...
const DATABASE_URL =
  ...
  "postgres://metanicator:metanicator@localhost:5432/metanicator?sslmode=disable";
  ...
  try {
    ...
    await page.addInitScript(
      ({ authToken, activeSessionId }) => {
        localStorage.setItem("metanicator_token", authToken);
        localStorage.setItem("metanicator:chat:activeSessionId", activeSessionId);
