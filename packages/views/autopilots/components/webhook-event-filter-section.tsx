...
import type { WebhookEventFilter } from "@metanicator/core/types";
...
export function WebhookEventFilterSection({
  ...
  const docsHref = i18n.language?.startsWith("zh")
    ? `https://metanicator.ai/docs/zh/autopilots#${encodeURIComponent("事件过滤")}`
    : "https://metanicator.ai/docs/autopilots#event-filters";
