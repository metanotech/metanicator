...
// Mock @metanicator/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
vi.mock("@metanicator/core/issues/stores/view-store", () => ({
...
vi.mock("@metanicator/core/issues/stores/issues-scope-store", () => ({
...
vi.mock("@metanicator/core/issues/stores/selection-store", () => ({
...
vi.mock("@metanicator/core/issues/stores/recent-issues-store", () => ({
