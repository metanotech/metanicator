...
import { useCommentComposerStore, useCommentDraftStore } from "@metanicator/core/issues/stores";
...
vi.mock("@metanicator/core/hooks/use-file-upload", async () => ({
  ...(await vi.importActual<typeof import("@metanicator/core/hooks/use-file-upload")>(
    "@metanicator/core/hooks/use-file-upload",
  )),
