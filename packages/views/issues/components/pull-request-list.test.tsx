...
import type { GitHubPullRequest } from "@metanicator/core/types";
import enCommon from "../../locales/en/common.json";
import enIssues from "../../locales/en/issues.json";

const TEST_RESOURCES = { en: { common: enCommon, issues: enIssues } };

vi.mock("@metanicator/core/github/queries", async () => {
  const actual = await vi.importActual<typeof import("@metanicator/core/github/queries")>(
    "@metanicator/core/github/queries",
  );
  return {
    ...actual,
