...
import { dingtalkInstallationsOptions, dingtalkKeys } from "@metanicator/core/dingtalk";
import { api } from "@metanicator/core/api";
import type { DingTalkInstallation } from "@metanicator/core/types";
  ...
  const prefix = lang?.startsWith("zh")
    ...
    : lang?.startsWith("ja")
      ...
      : lang?.startsWith("ko")
        ? "/ko"
        : "";
  return `https://metanicator.ai/docs${prefix}/dingtalk-bot-integration`;
}
