...
vi.mock("@metanicator/core/github", async () => {
  const actual =
    await vi.importActual<typeof import("@metanicator/core/github")>("@metanicator/core/github");
  return {
    ...actual,
...
describe("GitHubTab", () => {
  ...
  it("clicking Disconnect opens the confirmation and only fires on confirm", async () => {
    ...
    expect(screen.getByText(/Metanicator will stop receiving webhooks/i)).toBeTruthy();
