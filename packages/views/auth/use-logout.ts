...
import { clearWorkspaceStorage, defaultStorage } from "@metanicator/core/platform";
import { resetAllRegisteredDrafts } from "@metanicator/core/drafts/cleanup-registry";
...
export function useLogout() {
  ...
  return useCallback(() => {
    ...
    defaultStorage.removeItem("metanicator_tabs");
