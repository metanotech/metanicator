...
import { selectRecentContexts, useRecentContextStore, type RecentContextEntry } from "@metanicator/core/chat";
...
import type { Issue, Project } from "@metanicator/core/types";
