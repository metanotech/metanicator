...
export interface Agent {
   ...
   *  template-created agents. Identity for "maintained by Metanicator" checks —
 ...
 * metanotech/metanicator#2174). Use `Skill` from a detail endpoint when you need
...
export interface RuntimeModelThinking {
   ...
   *  but not actively rendered today — Metanicator's empty `thinking_level`
